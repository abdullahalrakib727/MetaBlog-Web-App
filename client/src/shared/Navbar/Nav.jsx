...
function Nav() {
  ...
  return (
    <nav className="navbar bg-white  max-w-[1216px] mx-auto">
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 text-[#3B3C4A]">{navLinks}</ul>
      </div>
      <div className="navbar-end">
        <div className="dropdown dropdown-end relative">
          <input
            type="text"
            placeholder="Search"
            className="border px-3 py-1 bg-[#F4F4F5] w-full max-w-xs"
          />
