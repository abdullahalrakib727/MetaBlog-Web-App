...
const ErrorPage:FC = ():JSX.Element => {
    ...
    return (
        ...
        <header>
          <h3 className="font-space-mono font-semibold text-[19px] py-10 ml-10 text-white lg:ml-0">404 not found</h3>
        </header>
        <main>
          <div className="banner-container flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20">
            ...
            <div className="banner-text">
              <h1 className="text-white font-space-mono text-5xl font-semibold mb-9 md:mt-20 w-3/4">I have bad news for you</h1>
              <p className="banner-description text-white font-space-mono font-normal text-xl mb-16">
